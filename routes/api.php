...
Route::get(Mensajes::ETAPAS_URL, [EtapaController::class, 'show']);
Route::put(Mensajes::ETAPAS_URL, [EtapaController::class, 'update']);
Route::delete(Mensajes::ETAPAS_URL, [EtapaController::class, 'destroy']);
...
Route::get(Mensajes::TAREAS_URL, [TareaApiController::class, 'show']);
Route::post('/tareas', [TareaApiController::class, 'store']);
Route::put(Mensajes::TAREAS_URL, [TareaApiController::class, 'update']);
Route::delete(Mensajes::TAREAS_URL, [TareaApiController::class, 'destroy']);

// Tareas asignadas a operario
Route::get('/tareas-asignadas', [TareaApiController::class, 'tareasAsignadas']);

// Editar estado de tareas asignadas
Route::get('/tareas/estado/{id_tarea}/{id_empleado_tarea}', [TareaApiController::class, ']()_
