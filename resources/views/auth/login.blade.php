<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div>
            ...
            <select id="t_doc" name="t_doc" class="block mt-1 w-full" required autocomplete="off">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="num_doc" class="block mt-1 w-full"
                        type="text"
                        name="num_doc"
                        :value="old('num_doc')"
                        required autofocus/>
    ...
    <div class="flex items-center justify-center mt-4">
        <a class="mx-2" href="{{ route('login-google') }}"><i class="fa-brands fa-google"></i>{{ __('Google') }}</a>
