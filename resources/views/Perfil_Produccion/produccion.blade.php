...
{{--                 <div class="pro-btns">
                    ...
                    <div class="modal fade" id="agregar" tabindex="-1"  data-bs-backdrop="static">
                    ...
                    <div class="modal fade" id="tarea" tabindex="-1" data-bs-backdrop="static">
                        <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                            <div class="modal-content">
 ...
 --}}
        ...
        <!-- Modal de Selección -->
        @foreach ($producciones as $produccion)
        <div class="modal fade" id="selectionModal{{ $produccion->id_produccion }}" tabindex="-1">
        ...
        @foreach ($producciones as $produccion)
        <div class="modal fade" id="updateModalProduccion{{ $produccion->id_produccion }}" tabindex="-1"
        ...
        @foreach ($producciones as $produccion)
        <div class="modal fade" id="updateModalMaterias{{ $produccion->id_produccion }}" tabindex="-1"
            data-bs-backdrop="static">
            <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
        ...
        @foreach ($producciones as $produccion)
        <div class="modal fade" id="updateModalTareas{{ $produccion->id_produccion }}" tabindex="-1"
            data-bs-backdrop="static">
            <div class="modal-dialog modal-xl modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
