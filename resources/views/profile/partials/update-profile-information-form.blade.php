        ...
        <div>
            ...
            <div class="mt-3 mb-4  relative w-fit">
                <label for="imag_perfil" class="cursor-pointer group">
                    ...
                    <img src="{{ asset($img_route) }}" alt="Foto de perfil de {{ $name }}" class="w-36 h-36 rounded-full object-cover border-2 border-gray-300 shadow-sm  group-hover:opacity-75 transition duration-300">
